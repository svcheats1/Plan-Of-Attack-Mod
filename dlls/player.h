...
public:
	...
	virtual const char *	GetPlayerName() { return STRING( pl.netname ); }
	virtual void			SetPlayerName(const char *szName) { pl.netname = AllocPooledString( szName ); }
...
public:
	...
	void	IncrementScore( int nCount ) { m_iScore += nCount; }
