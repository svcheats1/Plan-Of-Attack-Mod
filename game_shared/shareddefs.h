...
#define TEAM_SPECTATOR			0   // spectator team
#define	TEAM_A					1
#define FIRST_TEAM				1
#define TEAM_B					2
#define LAST_TEAM				2
#define GET_OTHER_TEAM(team)	(team == TEAM_A ? TEAM_B : TEAM_A)
...
//#define SPRINT_RATIO	1.10f
//#define SPRINT_RATIO 1.375f
#define SPRINT_BONUS 60
#define DUCKING_RATIO	0.4f
