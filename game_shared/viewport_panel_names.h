...
#define PANEL_OBJECTIVES	"objectives"
#define PANEL_WORLDMAP		"world_map"
#define PANEL_STRATEGY		"strategy"
#define PANEL_TUTORIAL		"tutorial"
#define PANEL_PUNISH		"punish"
#define PANEL_STRATEGYEDITOR "strategyeditor"
