...
public:
	...
	virtual bool			PrecacheWeaponScriptFile( void );
	...
	virtual bool			UsesPrimaryAmmo( void );					// returns true if the weapon actually uses primary ammo
	virtual bool			UsesSecondaryAmmo( void );					// returns true if the weapon actually uses secondary ammo
...
public:
	...
	virtual bool			IsPrimaryEmpty( void );
	virtual bool			IsSecondaryEmpty( void );
	virtual int				GetAmmo1( void ) const;
	virtual int				GetAmmo2( void ) const;
	virtual int				GetClip1( void ) const { return Clip1(); } // JD made these
	virtual int				GetClip2( void ) const { return Clip2(); }
	virtual int				Clip1() const { return m_iClip1; }	// valve made these
	virtual int				Clip2() const { return m_iClip2; }
