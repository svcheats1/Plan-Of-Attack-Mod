...
// To use this, you must #include <vgui/ischeme.h>
#define XRES(x) vgui::scheme()->GetProportionalScaledValue(x)
#define YRES(y) vgui::scheme()->GetProportionalScaledValue(y)
