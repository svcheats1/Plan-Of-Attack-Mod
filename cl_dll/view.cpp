...
void CViewRender::Render( vrect_t *rect )
{
	...
	// @TRJ - this needs to happen at some point...
	// at the moment it happens so late that even hooks into vgui::Panel::OnScreenSizeChanged
	// have not yet registered the change to g_ScreenInfo... what the f*#k!?!?!?!?
	SetScreenSize();
