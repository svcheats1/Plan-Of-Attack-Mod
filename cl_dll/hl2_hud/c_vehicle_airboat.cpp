...
CLIENTEFFECT_REGISTER_BEGIN( PrecacheEffectAirboat )
CLIENTEFFECT_MATERIAL( "effects/splashwake1" )
CLIENTEFFECT_MATERIAL( "effects/splashwake4" )
...
private:
	...
	int	 DrawWake( void );
	void DrawSegment( const CBeamSeg &beamSeg, const Vector &vNormal );
...
// Input  : &beamSeg - 
//-----------------------------------------------------------------------------
void C_PropAirboat::DrawSegment( const CBeamSeg &beamSeg, const Vector &vNormal )
{
	// Build the endpoints.
...
#define	WAKE_STEPS	6
	...
	IMesh* pMesh = materials->GetDynamicMesh( 0, 0, 0, pMaterial );
