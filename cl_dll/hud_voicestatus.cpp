...
private:
	...
	CPanelAnimationVarAliasType( float, icon_tall, "icon_tall", "16", "proportional_float" );
	CPanelAnimationVarAliasType( float, icon_wide, "icon_wide", "16", "proportional_float" );

	CPanelAnimationVarAliasType( float, text_ypos, "text_ypos", "10", "proportional_float" );
	CPanelAnimationVarAliasType( float, text_xpos, "text_xpos", "18", "proportional_float" );
};
