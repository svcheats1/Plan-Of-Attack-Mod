...
DECLARE_MESSAGE(gHUD, ChangeTeam);
DECLARE_MESSAGE(gHUD, BuyMenu);
DECLARE_MESSAGE(gHUD, ChooseObjective);
DECLARE_MESSAGE(gHUD, ChangeSkill);
DECLARE_MESSAGE(gHUD, AllowPunish);
...
void CHud::Init( void )
{
	...
	HOOK_HUD_MESSAGE( gHUD, ChangeTeam );
	HOOK_HUD_MESSAGE( gHUD, BuyMenu );
	HOOK_HUD_MESSAGE( gHUD, ChooseObjective );
	HOOK_HUD_MESSAGE( gHUD, ChangeSkill );
	HOOK_HUD_MESSAGE( gHUD, AllowPunish );
