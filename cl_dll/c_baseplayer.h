...
public:
	...
	virtual int		GetArmor() const { return m_ArmorValue; }
	...
	virtual void SetObserverTarget(CBaseEntity *pEntity) { m_hObserverTarget = pEntity; }
	...
	virtual float				MaxSpeed() const		{ return m_flMaxspeed; }

	// Should this object cast shadows?
	// @TEMP @TRJ @SHADOWS
	// JD: try using the base class instead (C_BaseAnimating)
	// virtual ShadowType_t		ShadowCastType() { return SHADOWS_RENDER_TO_TEXTURE; /*return SHADOWS_NONE;*/ }
