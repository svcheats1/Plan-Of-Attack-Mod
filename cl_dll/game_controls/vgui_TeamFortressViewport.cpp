...
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	AddNewPanel( CreatePanelByName( PANEL_OBJECTIVES ) );
	AddNewPanel( CreatePanelByName( PANEL_STRATEGY ) );
	AddNewPanel( CreatePanelByName( PANEL_WORLDMAP ) );
	AddNewPanel( CreatePanelByName( PANEL_TUTORIAL ) );
	AddNewPanel( CreatePanelByName( PANEL_PUNISH ) );
	AddNewPanel( CreatePanelByName(	PANEL_STRATEGYEDITOR ) );
}
...
IViewPortPanel* CBaseViewport::CreatePanelByName(const char *szPanelName)
{
	...
	else if ( Q_strcmp(PANEL_OBJECTIVES, szPanelName) == 0 )
	{
		newpanel = new CObjectiveMenu(this);
	}
	else if ( Q_strcmp(PANEL_STRATEGY, szPanelName) == 0)
	{
		newpanel = new CStrategyMenu(this);
	}
	else if ( Q_strcmp(PANEL_CLASS, szPanelName) == 0 )
	{
		newpanel = new CClassMenu(this);
	}
	else if ( Q_strcmp(PANEL_WORLDMAP, szPanelName) == 0 )
	{
		newpanel = new CWorldMap(this);
	}
	else if( Q_strcmp(PANEL_TUTORIAL, szPanelName) == 0)
	{
		newpanel = new CTutorialMenu(this);
	}
	else if(Q_strcmp(PANEL_PUNISH, szPanelName) == 0)
		newpanel = new CPunishMenu(this);
	else if(Q_strcmp(PANEL_STRATEGYEDITOR, szPanelName) == 0)
		newpanel = new CStrategyEditor(this);
