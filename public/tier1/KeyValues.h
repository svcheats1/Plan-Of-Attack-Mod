...
public:
	...
	KeyValues *GetLastKey(void);
	void SetSubKey(KeyValues *pDat);
	...
	// set by symbol
	void SetWString(int keySymbol, const wchar_t *value );
	void SetString(int keySymbol, const char *value );
	void SetInt(int keySymbol, int value );
	void SetFloat(int keySymbol, float value );
	void SetPtr(int keySymbol, void *value );
	void SetColor(int keySymbol, Color value);

	// set the value for this key value
	void SetWString(const wchar_t *value );
...
private:
	...
	void SetWString( KeyValues *dat, const wchar_t *value );
	void SetString( KeyValues *dat, const char *value );
	void SetInt( KeyValues *dat, int value );
	void SetFloat( KeyValues *dat, float value );
	void SetPtr( KeyValues *dat, void *value );
	void SetColor( KeyValues *dat, Color value);
