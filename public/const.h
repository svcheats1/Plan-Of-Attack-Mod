...
#define FL_FROZEN_VIEW			(1 << 31)

typedef enum
{
	PLAYER_ACTION_UNKNOWN = 0,
	PLAYER_ACTION_DUCKING,
	PLAYER_ACTION_STANDING,
	PLAYER_ACTION_WALKING,
	PLAYER_ACTION_SPRINTING,
	PLAYER_ACTION_JUMPING,
	PLAYER_ACTION_CLIMBING,
	PLAYER_ACTION_FALLING,
	PLAYER_ACTION_FALLING_HURT,
	PLAYER_ACTION_MAX
} PLAYER_ACTION;

typedef enum {
	TIMER_STATE_COUNTDOWN = 0,
	TIMER_STATE_FROZEN,
	TIMER_STATE_DEACTIVATE,
} OBJECTIVE_TIMER_STATE;
